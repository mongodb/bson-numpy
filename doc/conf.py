...
copyright = u'MongoDB, Inc. 2016-present. MongoDB, Mongo, and the leaf logo are registered trademarks of MongoDB, Inc'
...
from bsonnumpy import __version__ as v
# The short X.Y version.
version = v.rsplit('.', v.count('.') - 1)[0]
